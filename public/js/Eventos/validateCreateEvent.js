$(function(){
    ...
    // Funciones que se ejecutan cuando haya un focusout en el id del input del formulario
    ...
    function check_eventAsisstant(){
        ...
        if(pattern.test(eventAsisstant) && eventAsisstant !== ''){
            ...
            $("#eventAsisstant_error_message").html("El nombre del invitado solo puede contener letras")
