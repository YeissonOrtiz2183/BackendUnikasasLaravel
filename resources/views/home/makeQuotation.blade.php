  ...
  <body>
    ...
    <a class="btn btn-" onclick="history.back()" role="button" style="margin-left: 4%;"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="currentColor" class="bi bi-arrow-left icono" viewBox="0 0 16 16">
      ...
      <form class="row g-4" action="{{ url('cotizaciones') }}" method="POST">
        @csrf {{-- token de seguridad para el formulario  --}}
          ...
          <div class="col-md-4 inputValidate">
            ...
            <input type="text" max="10" class="form-control formborder" id="telefonoCotizante" placeholder="Telefono" aria-describedby="validationServer03Feedback" required name="telefono_cotizante">
          ...
          <div class="col-md-4 inputValidate">
            ...
            <span id="ciudadCotizante_error_message" class="error_form"></span>
          </div>

          <div class="col-md-4 inputValidate">
              <label for="productoCotizante" class="form-label">Producto</label>
              <select class="form-select formborder" id="productoCotizante" placeholder="Producto" aria-describedby="validationServer04Feedback" required name="producto_id" readonly>
                <option value="{{ $product->id }}">{{ $product->nombre_producto}}</option>
              </select>
              <span id="productoCotizante_error_message" class="error_form"></span>
            </div>
            ...
            <div class="col-md-4 inputValidate">
              ...
              <input type="date" class="form-control formborder" id="fecha" id="fechaCotizacion" placeholder="Ubicacion" aria-describedby="validationServer05Feedback" required name="fecha_cotizacion">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="D" id="exampleModalLabel"> Crear cotización</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center">
                  Esta seguro de que desea crear la cotizacion
                </div>
          ...
          <div class="container row g-2" style="margin-bottom: 1.5%; margin-top: 1.5%">
              <div class="row gap-10" style="margin: 0 auto;">
                <div class="col-3"></div>
                <div class="col-3">
                  <button class="btn btn-warning buttonUno" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2" id="submit" disabled>Crear</button>
                </div>
                <div class="col-3">
                  <a onclick="history.back()"><button class="btn btn-danger buttonDos" type="button">Cancelar</button></a>
                </div>
              </div>
          </div>
        </form>
      ...
      <script src="{{ asset('js/Cotizaciones/validateCreateCotizacion.js') }}"></script>
    @endsection
  </body>
  </html>
