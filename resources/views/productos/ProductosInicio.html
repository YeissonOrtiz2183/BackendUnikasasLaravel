...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('productosCss/ProductosInicio.css') }}"/>
    <link rel="stylesheet" href="{{asset('productosCss\modalP.css')}}"> 
    <link rel="stylesheet" href="{{asset('productosCss/modalPublicarProducto.css')}}">  
    <link rel="stylesheet" href="{{asset('productosCss/mPublicarProducto.css')}}">
    <link rel="stylesheet" href="{{URL.asset('productosCss/prueba.css')}}">
</head>
<body>
 <main>
        <h1>PRODUCTOS</h1>
...
<!--Fin modal producto-->
        <div class="prueba">
            ...
            <div class="MatrizProductos">  
                <div class="caja">
                    ...
                    <img src="Img-Productos/House1.jpg">
                    <div class="iconos">
                ...
                <div class="caja">
                    ...
                    <img src="Img-Productos/house2.jpeg">
                    <div class="iconos">
                        <a href="./VisualizarProducto/VisualizarProducto.html"><svg class="eye"xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <circle cx="12" cy="12" r="2" />
                ...
                <div class="caja">
                    ...
                    <img src="Img-Productos/house3.jpg">
                    <div class="iconos">
                        <a href="./VisualizarProducto/VisualizarProducto.html"><svg class="eye"xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <circle cx="12" cy="12" r="2" />
                ...
                <div class="caja">
                    ...
                    <img src="Img-Productos/house4.jpg">
                    <div class="iconos">
                        <a href="./VisualizarProducto/VisualizarProducto.html"><svg  class="eye"xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <circle cx="12" cy="12" r="2" />
                ...
                <div class="caja">
                    ...
                    <img src="Img-Productos/house5.jpg">
                    <div class="iconos">
                ...
                <div class="caja">
                    ...
                    <img src="Img-Productos/house6.jpg">
                    <div class="iconos">
                        <a href="./VisualizarProducto/VisualizarProducto.html"><svg  class="eye"xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <circle cx="12" cy="12" r="2" />
                ...
                <div class="caja">
                    ...
                    <img src="Img-Productos/house7.jpg">
                    <div class="iconos">
                        <a href="./VisualizarProducto/VisualizarProducto.html"><svg  class="eye"xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <circle cx="12" cy="12" r="2" />
                ...
                <div class="caja">
                    ...
                    <img src="Img-Productos/house8.jpg">
                    <div class="iconos">
                        <a href="./VisualizarProducto/VisualizarProducto.html"><svg  class="eye"xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <circle cx="12" cy="12" r="2" />
    ...
    <script src="{{asset ('productosJs/modalP.js')}}"></script>
