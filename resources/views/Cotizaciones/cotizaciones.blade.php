...
<body>
  ...
  <div class="mb-2 row row row col-3">
    ...
    <div class="col-sm-8">
      ...
      <input type="submit" class="btn btn-warning" value="Buscar" style="width: 12%; font-size: 1.20rem; font-weight: 600">
    </div>
    </div>
  </div>
  <br>
    ...
    <div class="container">
        <div class="row row-cols-5">
          ...
          <div class="modal fade" id="exampleModal4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
           ...
           </svg><a class="btn btn-light" href="{{ url('cotizaciones/'.$cotizacion->id.'/contestar') }}" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
      ...
      <div class="container" style="margin-bottom: 1%">
        <div class="row row col-2" style="margin: 0 auto;"><a href="{{ url('/exportPdfCotizaciones') }}"><button type="button" class="btn btn-lg btn-warning" data-bs-toggle="popover" title="Click para ver el reporte en formato pdf o excel" data-bs-content="And here's some amazing content. It's very engaging.Right?" style="font-size: 1.20rem; font-weight: 600">Reporte PDF</button></a></div>
      </div>
