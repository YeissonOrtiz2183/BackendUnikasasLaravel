...
<head>
    ...
    <title>Responder cotizacion</title>
</head>
<body>
    ...
    <form class="row g-4" action="" method="">
      @csrf {{-- token de seguridad para el formulario  --}}
        ...
        <div class="col-md-4">
          ...
          <input type="text" class="form-control" placeholder="Nombre" name="nombres_cotizante"
          value="{{ isset($cotizacion->nombres_cotizante)?$cotizacion->nombres_cotizante:old('nombre_cotizante') }}" readonly>
        </div>

        <div class="col-md-4">
          <label class="form-label">Apellido</label>
          <input type="text" class="form-control" placeholder="Apellido" name="apellidos_cotizante"
        ...
        <div class="col-md-4">
          ...
          <div class="input-group has-validation">
            ...
            <input type="email" class="form-control" placeholder="Email" aria-describedby="inputGroupPrepend3 validationServerUsernameFeedback" required name="email_cotizante"
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" placeholder="Ubicacion" aria-describedby="validationServer05Feedback" required name="ubicacion_cotizante"
