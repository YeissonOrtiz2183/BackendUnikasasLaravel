...
<head>
    ...
    <title>Segunda opcion de cotizacion</title>
</head>
<body>
 ...
 <center> <h1> <strong>Crear cotizacion</strong></h1></center>
    <div class="container">
    <form class="row g-4" action="{{ url('cotizaciones') }}" method="POST">
      @csrf {{-- token de seguridad para el formulario  --}}
        ...
        <div class="col-12">
          <button class="btn btn-primary" type="submit" data-bs-toggle="modal"  data-bs-target="#exampleModal2" >Crear</button>
        </div>
      </form>
    </div>
