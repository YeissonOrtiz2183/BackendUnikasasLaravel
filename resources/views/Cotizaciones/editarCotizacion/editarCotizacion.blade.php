...
<body>
  <a class="btn btn-" onclick="history.back()" role="button" style="margin-left: 4%;"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="currentColor" class="bi bi-arrow-left icono" viewBox="0 0 16 16">
    ...
    <h1 style="text-align: center; margin-bottom: 1%"><strong>Editar cotización</strong></h1>
    <div class="container">
    <form class="row g-4" action="{{ url('cotizaciones/'.$cotizacion->id) }}" method="post">
      @csrf {{-- token de seguridad para el formulario  --}}
        ...
        <div class="col-md-4">
            ...
            <select class="form-select is-invalid" id="validationServer04" placeholder="Producto" aria-describedby="validationServer04Feedback" required name="producto_id">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="D" id="exampleModalLabel"> Editar la cotización</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                ¿Esta seguro de que desea editar la cotización?
              </div>
        ...
        <div class="container row g-2" style="margin-bottom: 1.5%; margin-top: 1.5%">
          <div class="row gap-10" style="margin: 0 auto;">
            <div class="col-3"></div>
            <div class="col-3">
              <button class="btn btn-warning buttonUno" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2" style="font-size: 1.20rem; font-weight: 600">Confirmar cambios</button>
            </div>
            <div class="col-3">
